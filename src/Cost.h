...
public:
     ...
     *
     * @param x Vector which is the final state in a trajectory
     ...
     */
    virtual double phi(arma::vec x, arma::vec x_star);
     ...
     */
    virtual arma::vec phi_x(arma::vec x, arma::vec x_star);
     ...
     */
    virtual arma::mat phi_xx(arma::vec x, arma::vec x_star);
     ...
     */
    virtual double L(arma::vec x, arma::vec u, double dt);
     ...
     */
    virtual double L_x(arma::vec x, arma::vec u, double dt);
     ...
     */
    virtual double L_u(arma::vec x, arma::vec u, double dt);
     ...
     */
    virtual double L_xx(arma::vec x, arma::vec u, double dt);
     ...
     */
    virtual double L_uu(arma::vec x, arma::vec u, double dt);
     ...
     */
    virtual double L_xu(arma::vec x, arma::vec u, double dt);
     ...
     */
    virtual double L_ux(arma::vec x, arma::vec u, double dt);
};
