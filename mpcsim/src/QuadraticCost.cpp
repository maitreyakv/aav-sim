...
arma::mat QuadraticCost::L_uu(arma::vec, arma::vec, double dt) {
    // Compute and return the Hessian of the transition cost with respect to the control
    return this->m_R * dt;
}

arma::mat QuadraticCost::L_xu(arma::vec x, arma::vec u, double) {
...
arma::mat QuadraticCost::L_ux(arma::vec x, arma::vec u, double) {
